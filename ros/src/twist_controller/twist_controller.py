...
class Controller(object):
    def __init__(self, vehicle_properties):
        ...
        self.yaw = YawController(
            ...
            steer_ratio = vp.steer_ratio,
            0.1 # min speed
            min_speed = vp.max_lat_accel,
            max_steer_angle = vp.max_steer_angle
        )
        ...
        self.pid = PID(
            ...
            kd=0.05,                 # kd is derivative term
            mn = vp.decel_limit,     # min
            mx = vp.accel_limit      # max
        )
    ...
    def control(self, twist_cmd, current_vel, dbw_enabled):
        ...
        steering_control = self.steering_filter(steering_control)
        ...
        if linear_vel == 0. and current_vel < .01:
            ...
            throttle_control = 0
            decel = max(vel_error, vp.decel_limit)
